...
<script type="text/javascript">
    ...
    function changeStatus(){
        ...
        var sURL = "{contextPath}/dataVindicate/updateStatus.action?type=item";
    ...
    function queryData(){
        ...
        //查询
        var sURL = "{SYSURL.oa}/dataVindicate/queryItemListByPage.action?t={JSTime}&currentPage={page}&pageSize={pageSize}&parameter="+encodeURIComponent(data);;
        jt.setAttr(_('#tabMain_List'),'URLData',sURL);
        _('#tabMain_List').loadData();
    }

    function editItem(id){
        var sURL='{contextPath}/jsp/dataVindicate/xmlDetail.jsp?t={JSTime}&id='+id + '&type=item&status='+ status;
...
<body class="BodyList">
    ...
    <div id="divFixCnt" class="GridOnly" >
        <table class="Grid" style="text-align:center;" FixHead="true" id="tabMain_List" border="0"	cellspacing="0" cellpadding="0"
               URLData="{SYSURL.oa}/dataVindicate/queryItemListByPage.action?t={JSTime}&currentPage={page}&pageSize={pageSize}&status={status}"
            ...
            <col caption="事项名称" field="{ITEM_NAME}" align="center" width="100px">
            <col caption="事项编码" field="{ITEM_CODE}" align="center" width="100px">
