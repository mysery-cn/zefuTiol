...
<script type="text/javascript">
    ...
    function changeStatus(){
        ...
        var sURL = "{contextPath}/dataVindicate/updateStatus.action?type=meeting";
    ...
    function queryData(){
        ...
        //查询
        var sURL = "{SYSURL.oa}/dataVindicate/queryMeetingListByPage.action?t={JSTime}&currentPage={page}&pageSize={pageSize}&parameter="+encodeURIComponent(data);;
        jt.setAttr(_('#tabMain_List'),'URLData',sURL);
        _('#tabMain_List').loadData();
    }

    function editItem(id){
        var sURL='{contextPath}/jsp/dataVindicate/xmlDetail.jsp?t={JSTime}&id='+id + '&type=meeting&status='+ status;
...
<div id="divFixCnt" class="GridOnly" >
    <table class="Grid" style="text-align:center;" FixHead="true" id="tabMain_List" border="0"	cellspacing="0" cellpadding="0"
           URLData="{SYSURL.oa}/dataVindicate/queryMeetingListByPage.action?t={JSTime}&currentPage={page}&pageSize={pageSize}&status={status}"
        ...
        <col caption="会议类型" field="{TYPE_NAME}" align="center" width="50px">
