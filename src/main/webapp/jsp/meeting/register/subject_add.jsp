...
<div class="form_top">
    <div class="form_top_btn">
        ...
        <a class="btn_upload" href="javascript:void(0)" id="uploadAttachmentBt" onclick="uploadAttachment()" style="display: none">上传附件</a>
    </div>
</div>
        ...
        <div class="form_issue">
            ...
            <table id="subjectTable" style="margin-top: 0px">
                ...
                <tr>
                    ...
                    <td>
                        <select class="DropDown_Select" id="sourceId" name="sourceId" style="border:1px solid #dfdfdf;width: 100%;"
                                urldata="{contextPath}/source/querySourceList.action" optiontext="{SOURCE_NAME}" optionvalue="{SOURCE_ID}">
                        </select>
                    </td>
                    <td class="td_name">专项名称</td>
                    <td>
                        <select class="DropDown_Select" id="specialId" name="specialId" style="border:1px solid #dfdfdf;width: 100%;"
                ...
                <td colspan="3">
                    <input type="text" id="subjectUser" name="subjectUser" placeholder=" 请输入列席人员"  maxlength="80" style="margin-top: 5px;" ErrEmptyCap="列席人员不允许为空">
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea name="subjectResult" placeholder="请输入议题决议" maxlength="300" style="width: 100%"  ErrEmptyCap="决议内容不允许为空"></textarea></td>
                </tr>
                <tr>
                    <td class="td_name"><font style="color: RED;">*</font>审议结果</td>
                    <td colspan="3">
                        <textarea id="deliberations" name="deliberations" placeholder="请输入审议结果" ErrEmptyCap="审议结果不允许为空"  maxlength="80" style="padding-bottom: 0px;margin-bottom: 0px;width: 97%"></textarea>
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea name="remark" placeholder="请输入备注" maxlength="80" style="width: 100%"></textarea></td>
                </tr>
            </table>
            </form>
        </div>
...
<script type="text/javascript">
    ...
    function saveForm(){
        ...
        postJSON(sURL, jt.Form2Json(aForm), function (json, o) {
            if (json.errorCode == 0) { //保存成功
                ...
                $("#isUpdate").val("1");
                $("#subjectId").val(json.data[0].subjectId);
    ...
    function validateItem(object){
        ...
        var sURL = "{contextPath}/item/queryItemListByCompanyId.action?companyId="+companyId;
        var useNum = 0;
    ...
    function selectLinkSubject(){
        var sURL = "{contextPath}/jsp/meeting/register/subject_link.jsp?companyId="+companyId;
