...
<tr>
	...
	<td style="vertical-align:top;" >
		...
		<div class="list_main" style="height: 520px;">
			<table class="Grid" style="text-align:center;" FixHead="true" id="tabMain_List" style="text-align:center;" border="0" cellspacing="0" cellpadding="0"  
				URLData="{contextPath}/statistics/item/queryItemList.action?currentPage={page}&pageSize={pageSize}&catalogId=${catalogId}"
				EmptyInfo="没有记录" width="100%">
				<col caption="序号" field="{RN}" width="15" align="center">
				<col caption="企业名称" field="{companyName}" width="50" align="center">
				<col caption="事项名称" field="{itemName}" width="50" align="center">
				<col caption="事项编码" field="{itemCode}" width="25" align="center">
	...
	<script type="text/javascript" src="<%=SYSURL_static%>/js/statistics/leader/leader_item_detail_all.js"></script>
	<!--树状菜单开始-->
