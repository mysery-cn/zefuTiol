					...
					<div id="treeDiv" class="content_main_left">
						...
						<div class="industry_contents">
							<a class="industry_contents_cur" style="font-size:15px;"
								onclick="reloadTableData('','','',this);">全部类型</a>
						</div>
					</div></td>
				...
				<td style="vertical-align:top;">
					<div class="list_all">
						<div class="list_title">
							<p style="font-size:16px;" id="tableTitle">企业会议列表</p>
						...
						<div id="search" class="list_search">
							<table>
								<tr>
									...
									<td style="width:100px"><p>会议类型：</p></td>
								...
								<tr>
									...
									<td style="width:100px;"><div class="btn_submit"
											onclick="queryData()">
											<a>查询</a>
										</div></td>
									<td style="width:100px"><div class="btn_reset"
											onclick="resetAll()">
											<a>重置</a>
										</div></td>
								</tr>
						...
						<div class="list_main">
							...
							<table class="Grid" style="text-align:center;" FixHead="true"
								...
								URLData="{contextPath}/statistics/decision/queryDecisionMeetingList.action?currentPage={page}&pageSize={pageSize}&companyId=${companyId }&statisticsType=${statisticsType}&objectId=${objectId}&industryId=${industryId}">
								<col caption="序号" field="{RN}" width="50" align="center">
								<col caption="企业名称" field="{companyName}" width="auto"
									align="center">
								<col caption="会议名称" width="300" align="left"
									field="<a style='color:blue' href=&quot;javascript:viewMeetingDetail('{companyId}','{meetingId}');&quot;>
								{meetingName}
								</a>" >
								<col caption="会议日期" field="{meetingTime}" width="240"
									align="center">
								<col caption="会议类型" field="{meetingType}" width="240"
									align="center">
							</table>
						</div>
					</div>
...
<script type="text/javascript"
	src="<%=SYSURL_static%>/js/statistics/leader/decision_meeting_list.js"></script>
<script type="text/javascript"
	src="<%=SYSURL_static%>/js/tiol_common.js"></script>
</html>
