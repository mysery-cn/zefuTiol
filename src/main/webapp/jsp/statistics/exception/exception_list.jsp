...
<tr>
	...
	<td style="vertical-align:top;" >
		...
		<hr/>
			<div class="list_main" id="regulationDiv" >
				<table  class="Grid" style="text-align:center;" GridHeight="500px" FixHead="true" align="right" id="regulation_List" border="0" cellspacing="0" cellpadding="0"  
			...
			<div class="list_main" id="subjectDiv" >
				<table  class="Grid" style="text-align:center;" GridHeight="500px" FixHead="true" align="right" id="subject_List" border="0" cellspacing="0" cellpadding="0"  
					...
					<col caption="党委会未前置" field="<a style='color:blue' href=&quot;javascript:subjectView('{COMPANY_ID}','1');void(0);&quot;>{type1}</a>" width="50" align="center">
					...
					<col caption="未经合法合规审查" field="<a style='color:blue' href=&quot;javascript:subjectView('{COMPANY_ID}','3');void(0);&quot;>{type3}</a>" width="50" align="center">
	...
	<script type="text/javascript">
		...
		function subjectView(companyId,exceptionType){
			...
			window.parent.addpage("企业异常议题列表",href,'exceptionSubjectCompany');
		}
	</script>
</html>
