...
<table>
<tr><td width="50%" style="padding-right: 20px;">
	<div class="list_all">
	<div class="list_title"><p>重要人事任免会议分布</p></div>
	<div class="chart_img_gai"><div id="container_1" style="height: 220px;width: 95%;margin: 0 auto;"></div></div>
	</div>
</td>
<td width="50%">
	<div class="list_all">
	<div class="list_title"><p>重要人事任免议题情况</p></div>
	<div class="chart_img_gai"><div id="container_2" style="height: 220px;width: 95%;margin: 0 auto;"></div>
	</div>
</td>
</tr>
</table>
	<div class="list_all">
		...
		<tr>
            ...
            <td style="margin-right: -20px;" width="200px;"><div class="select_diy">
                <select id="meetingType" name="">
        ...
        <tr>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:50%;"><input id="startDate" style="width: 90px;" class="Input_DateTime input">
                    </td>
                    <td>至
                    </td><td style="width:50%;"><input id="endDate" style="width: 90px;" class="Input_DateTime input">
                </td>
                </tr>
            </table>
		    <td width="90px;">
                <div class="btn_submit" onclick=""><a onclick="queryData()">查询</a>
                </div>
		    </td>
            <td width="120px;">
                <div class="btn_reset" onclick="resetSearchValue()"><a>重置</a>
                </div>
            </td>
		<td>&nbsp;</td>
		</tr>
		...
		<div class="list_main">
			...
			<table class="Grid" FixHead="true" id="tabMain_List" border="0" cellspacing="0" cellpadding="0" Action="querySubjectDetail('{subjectId}','{meetingId}','{companyId}')"  
	...
	jQuery(function($) {	
		$.ajax({
			url : "/enterpriseTwo/queryMeetingDetail.action",
			type : "POST",
			async: false, 
	        success: function (result) {
		...
		$.ajax({
			url : "/enterpriseTwo/querySubjectDetail.action",
			type : "POST",
			async: false, 
	        success: function (result) {
				names = result.data[0].name;
