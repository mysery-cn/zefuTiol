...
<table>
	...
	<td width="60%" style="padding-right: 12px;">
		<div class="list_all">
		<div class="list_title"><p id="yeari"></p></div>
		<div class="chart_img_gai" style="height: 200px;width: 95%;margin: 0 auto;" id="methz"></div>
		</div>
	</td>
	<td>
		<div class="list_all">
		<div class="list_title"><p id="years"></p></div>
		<div class="chart_img_gai" style="height: 200px;width: 95%;margin: 0 auto;" id="metcla"></div>
		<div id="imgno" style="height: 249px;width: 95%;margin: 0 auto;display: none;text-align:center;"></"></div>
		</div>
	</td>
	</tr>
	<tr>
	...
	<div class="list_all">
		...
		<table>
		<tr>
		<td width="100px"><p>企业名称：</p></td><td width="280px">
			<input id="companyName" type="text" placeholder="请输入企业名称"></td>
		<td width="100px"><p>会议名称：</p></td><td width="280px">
			<input id="meetingName" type="text" placeholder="请输入会议名称"></td>
		<td width="100px"><p>议题名称：</p></td><td width="280px">
		...
		<td width="100px"><p>会议决议内容：</p></td><td width="280px;">
			<input id="subjectResult" type="text" placeholder="请输入决议情况内容"></td>
		...
		<div class="total_num"><p>当前会议总数：</p><span id="all">0</span></div><div class="no_front"><p>有权限查看数：</p><span id="have">0</span></div><div class="no_front"><p>无权限查看数：</p><span id="not">0</span></div>
			<table class="Grid" style="text-align:center;" FixHead="true" id="tabMain_List" border="0" cellspacing="0" cellpadding="0"
				...
				<col caption="会议时间" field="{MEETING_TIME}" width="50" align="center">
				<col caption="是否经过董事会决策" field="[=formatStatus('{VIA_FLAG}')]" width="20" align="center">
				<col caption="是否经过履行决策制度" field="[=confirmStatus('{exception}')]" width="20" align="center">
	...
	<script type="text/javascript" src="<%=SYSURL_static%>/js/planning/planning_list.js"></script>
	<script type="text/javascript">
		var year = new Date().getFullYear();
		document.getElementById("yeari").innerHTML = year+'年决策议题情况';
		document.getElementById("years").innerHTML = year+'年董事会决策情况';
		year = year - 2017;
		...
		function confirmStatus(code){
		    ...
		    return '<img title="'+code+'" src="<%=SYSURL_static%>/images/tiol/ico_no.png">';		    
		}
		loadingIndustry();
		loadingView();
		getAutoCount();
