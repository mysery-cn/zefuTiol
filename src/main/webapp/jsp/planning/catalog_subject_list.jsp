...
<tr>
	...
	<td style="vertical-align:top;" >
		...
		<table>
		<tr>
		<td style="width:100px"><p>企业名称：</p></td><td style="width:180px">
			<input id="companyName" type="text" placeholder="请输入企业名称"></td>
		<td style="width:100px"><p>议题名称：</p></td><td style="width:180px">
			<input id="subjectName" type="text" placeholder="请输入议题名称"></td>
		<td style="width:100px"><p>决议内容：</p></td>
    	...
    	<tr>
		<td style="width:100px"><p>是否董事会决策：</p></td>
		<td style="width:180px">
      		<div class="select_diy">
       		<select name="viaFlag" id="viaFlag">
	...
	<script type="text/javascript" src="<%=SYSURL_static%>/js/planning/catalog_subject_list.js"></script>
