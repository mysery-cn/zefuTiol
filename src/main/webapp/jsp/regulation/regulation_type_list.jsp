...
<script type="text/javascript">
	...
	function editItem(typeId){
		var sURL='{contextPath}/jsp/regulation/regulation_type_update.jsp?t={JSTime}&typeId='+typeId;
	...
	function delItem(sID){
		...
		var sURL='{contextPath}/regulation/deleteRegulationType.action';
...
<body class="BodyList">
	<div id="divFixTop">
		<div class="ToolbarLite" iconPath="{SYSURL.static}/images/icon16/">
            ...
            <!-- <div icon="export.png" id="exportButton" onclick="synchronous('regulation_type.xml')">同步</div> -->
		</div>
	</div>
	<div id="divFixCnt" class="GridOnly" >
		<table class="Grid" style="text-align:center;" FixHead="true" id="tabMain_List" border="0"	cellspacing="0" cellpadding="0" 
			URLData="{SYSURL.oa}/regulation/queryRegulationTypeListByPage.action?t={JSTime}&currentPage={page}&pageSize={pageSize}&{searchParam}"
