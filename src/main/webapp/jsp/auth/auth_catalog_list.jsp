...
<script type="text/javascript">
	...
	function editItem(catalogId){
		var sURL='{contextPath}/jsp/auth/auth_catalog_update.jsp?t={JSTime}&catalogId='+catalogId;
		...
		<td>
			<div id="divFixMain" class="GridOnly">
				<table class="Grid" style="text-align:center;" FixHead="true" id="tabMain_List" border="0" cellspacing="0" cellpadding="0"  Action="editItem('{navId}')"
					   URLData="{contextPath}/authCatalog/queryAuthCatalogList.action?t={JSTime}&catalogId={curNavID}&currentPage={page}&pageSize={pageSize}&{searchParam}" EmptyInfo="没有记录" width="100%" AutoLoadData="false">
