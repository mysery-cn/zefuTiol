...
function loadMessage(){
	...
	postJSON(dataURL,jPost,function(json,o){
		if (!json || json.errorCode != "0") {
			...
			var companyName = json.data[0].companyName;
...
function reloadItem(catalogId){
	...
	//请求路径
	var data = "{\"companyID\":\""+companyID+"\",\"itemName\":\""+itemName+"\",\"catalogId\":\""+catalogId+"\"}";
	var sURL = "{contextPath}/statistics/item/queryItemListByCatalog.action?currentPage={page}&pageSize={pageSize}&parameter="+encodeURIComponent(data);
