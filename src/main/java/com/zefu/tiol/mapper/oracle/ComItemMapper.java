...
public interface ComItemMapper {
	...
	/**
	 * @功能描述: TODO 根据ID查询事项清单
	 * @参数: @param param 多ID用","隔开
	 * @参数: @return
	 * @创建人 ：李晓军
	 * @创建时间：2018年11月18日 上午11:55:49
	 */
	List<Map<String, Object>> queryItemByIds(Map<String, Object> param);
	 ...
	 * @author 李晓军
	 */
	void deleteItemByids(Map<String, Object> param);
	 ...
	 * @author 李晓军
	 */
	void updateItemStatusByids (Map<String, Object> param);
	 ...
	 * @param param
	 */
	void deleteItemMeetingByids(Map<String, Object> param);
	...
	/**
	 * 判断企业事项是否存在
	 * @param param CURRENT_USER.companyId ,itemCode,itemName
	 * @return
	 * @author 李晓军
	 */
