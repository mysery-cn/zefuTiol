 ...
 * @版本信息：V1.0
 */
public interface DataVindicateService {
     ...
     * @创建时间：2018年11月2日 上午9:49:52
     */
    List<Map<String, Object>> queryRegulationListByPage(Map<String, Object> param, Page<Map<String, Object>> page);
     ...
     * @创建时间：2018年11月2日 上午9:49:52
     */
    List<Map<String, Object>> queryMeetingListByPage(Map<String, Object> param, Page<Map<String, Object>> page);
     ...
     * @创建时间：2018年11月2日 上午9:49:52
     */
    List<Map<String, Object>> querySubjectListByPage(Map<String, Object> param, Page<Map<String, Object>> page);
